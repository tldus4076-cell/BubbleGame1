...
이번에는 기능 목록 25번인 "왼쪽 벽 반사"만 만들고 싶어.
...
현재 상태:
- 기능 1번~24번은 완료했어. (22번 모바일 터치는 패스)
...
3. 기능 25번이 성공하면 다음에는 기능 26번 프롬프트를 만들면 됩니다.
