...
이번에는 기능 목록 41번인 "스테이지 이름 저장"만 만들고 싶어.
...
- 아직 스테이지 이름을 저장하고 화면에 표시하는 기능이 없어.
...
목표:
스테이지 이름을 저장하고 화면에 표시하고 싶어.
Stage 1을 플레이하면 "Stage 1", Stage 2를 플레이하면 "Stage 2"가 화면에 보이게 하고 싶어.

조건:
- Unity 6 2D 프로젝트 기준으로 설명해줘.
- 이번에는 기능 41번 "스테이지 이름 저장"만 만들어줘.
...
- 새 스크립트 StageDataController.cs를 만들어줘.
- 기존 스크립트는 수정하지 마.
- Inspector에서 스테이지 이름을 직접 입력할 수 있게 해줘.
...
- Inspector에서 stageName을 "Stage 2"로 바꾸면 표시도 바뀌는지 확인.
